...
for %%x in (%*) do (
	...
	(
        ...
        echo         "textures": { 
        echo             "flowerpot": "neutronia:blocks/flower_pot_stained_%%x",
        echo             "particle": "neutronia:blocks/flower_pot_stained_%%x"
        echo         }
        echo     },
        echo     "variants": {
    ...
    (
        ...
        echo     "textures": { 
        echo         "layer0": "neutronia:items/flower_pot_stained_%%x"
        echo     }
        echo }
