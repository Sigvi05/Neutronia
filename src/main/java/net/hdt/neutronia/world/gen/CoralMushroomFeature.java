        ...
        for (int i1 = 0; i1 <= j; ++i1)
        {
            for (int j1 = 0; j1 <= i; ++j1)
            {
                for (int k1 = 0; k1 <= k; ++k1)
                {
                    ...
                    if ((i1 != 0 && i1 != j || j1 != 0 && j1 != i) && (k1 != 0 && k1 != k || j1 != 0 && j1 != i) && (i1 != 0 && i1 != j || k1 != 0 && k1 != k) && (i1 == 0 || i1 == j || j1 == 0 || j1 == i || k1 == 0 || k1 == k) && p_204623_2_.nextFloat() >= 0.1F) {
                        this.generate(p_204623_1_, p_204623_2_, blockpos$mutableblockpos);
                    }
                }
            }
        }
