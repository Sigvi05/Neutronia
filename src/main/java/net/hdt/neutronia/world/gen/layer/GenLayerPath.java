package net.hdt.neutronia.world.gen.layer;
...
public class GenLayerPath extends GenLayer
{
    public GenLayerPath(long p_i2128_1_, GenLayer p_i2128_3_)
    {
        super(p_i2128_1_);
    ...
    public int[] getInts(int areaX, int areaY, int areaWidth, int areaHeight)
    {
        ...
        for (int i1 = 0; i1 < areaHeight; ++i1)
        {
            for (int j1 = 0; j1 < areaWidth; ++j1)
            {
                ...
                {
                    aint1[j1 + i1 * areaWidth] = Biome.getIdForBiome(NBiomes.PATH);
                }
            }
        }
