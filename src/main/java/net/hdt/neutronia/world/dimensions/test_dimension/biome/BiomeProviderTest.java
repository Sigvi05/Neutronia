package net.hdt.neutronia.world.dimensions.test_dimension.biome;
...
public class BiomeProviderTest extends BiomeProvider {

    public BiomeProviderTest(World world) {
        super();
