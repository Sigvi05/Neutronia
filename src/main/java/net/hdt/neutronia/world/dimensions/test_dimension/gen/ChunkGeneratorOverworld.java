...
import net.hdt.neutronia.world.dimensions.test_dimension.gen.structure.WoodlandMansion;
...
{
    protected static final IBlockState STONE = NBlocks.newStoneVariants[7].getDefaultState();
    ...
    public ChunkGeneratorOverworld(World worldIn, long seed, boolean mapFeaturesEnabledIn, String generatorOptions)
    {
        ...
        NoiseGeneratorOctaves forestNoise = new NoiseGeneratorOctaves(this.rand, 8);
                        ...
                        for (int k2 = 0; k2 < 4; ++k2)
                        {
                            ...
                            for (int l2 = 0; l2 < 4; ++l2)
                            {
                                if ((lvt_45_1_ += d16) > 0.0D)
                                {
                                    ...
                                    for (int blocks = 0; blocks < abyte.length; ++blocks)
                                    {
                                        abyte[blocks] = (byte)Biome.getIdForBiome(this.biomesForGeneration[i]);
                                        primer.setBlockState(i * 4 + k2, i2 * 8 + j2, l * 4 + l2, this.biomesForGeneration[(int)abyte[blocks]].fillerBlock);
                                    }
                                }
