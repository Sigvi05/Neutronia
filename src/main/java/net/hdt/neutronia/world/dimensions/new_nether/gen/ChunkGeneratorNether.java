package net.hdt.neutronia.world.dimensions.new_nether.gen;

import net.hdt.neutronia.api.world.biome.IBiomeWrapper;
import net.hdt.neutronia.util.handlers.ConfigHandler;
...
//        biomesForGen = world.getBiomeProvider().getBiomes(null, chunkX * 16, chunkZ * 16, 16, 16);
    ...
    public void populate(int chunkX, int chunkZ)
    {
        ...
        IBiomeWrapper wrapper = NetherBiomeManager.getBiomeWrapper(biome);
    ...
    public List<Biome.SpawnListEntry> getPossibleCreatures(EnumCreatureType creatureType, BlockPos pos)
    {
        ...
        return NetherBiomeManager.getBiomeWrapper(world.getBiome(pos)).getSpawnableMobs(creatureType);
    }
    ...
    private void replaceBiomeBlocks(int chunkX, int chunkZ, ChunkPrimer primer, Biome[] biomes)
    {
        ...
        for(int x = 0; x < 16; ++x)
        {
            for(int z = 0; z < 16; ++z)
            {
                IBiomeWrapper wrapper = NetherBiomeManager.getBiomeWrapper(biomes[x + z * 16]);
