package net.hdt.neutronia.world.biome.moon;
...
public class BiomeMoonMain extends Biome {
    ...
    public BiomeMoonMain() {
        super(new BiomeProperties("Moon Main").setBaseHeight(1.0F).setHeightVariation(0.1F).setTemperature(-5.0F).setRainfall(0.0F).setRainDisabled());
