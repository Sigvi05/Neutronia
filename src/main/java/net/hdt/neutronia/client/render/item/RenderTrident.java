...
import net.hdt.neutronia.entity.render.model.ModelTrident;
...
public class RenderTrident extends RenderArrow<EntityTrident>
{
    public static final ResourceLocation field_203087_a = new ResourceLocation(MOD_ID, "textures/entity/trident.png");
    ...
    {
        Entity entity = p_203085_1_.shootingEntity;

        if (entity != null && p_203085_1_.isOverWater())
        {
            Tessellator tessellator = Tessellator.getInstance();
            BufferBuilder bufferbuilder = tessellator.getBuffer();
            double d0 = this.func_203086_a((double)entity.prevRotationYaw, (double)entity.rotationYaw, (double)(p_203085_9_ * 0.5F)) * 0.01745329238474369D;
            ...
            for (int l = 0; l <= 37; ++l)
            {
                ...
                if (l > p_203085_1_.field_203052_f * 2)
                {
                    break;
                }
            }
            ...
            for (int i1 = 0; i1 <= 37; ++i1)
            {
                ...
                if (i1 > p_203085_1_.field_203052_f * 2)
                {
                    break;
                }
            }
