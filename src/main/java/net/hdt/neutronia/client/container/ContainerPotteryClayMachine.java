...
public class ContainerPotteryClayMachine extends Container {
    ...
    public ContainerPotteryClayMachine(InventoryPlayer playerInventory, IInventory furnaceInventory) {
