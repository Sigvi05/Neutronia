...
public class BlockCoralFan extends BlockWaterPlantBase {
    ...
    public boolean canPlaceBlockOnSide(World worldIn, BlockPos pos, EnumFacing side) {
        if (this == NBlocks.coralFan[color.getMetadata()] || this == NBlocks.deadCoralFan[color.getMetadata()] || this == NBlocks.decorativeCoralFan[color.getMetadata()] || this == NBlocks.decorativeDeadCoralFan[color.getMetadata()]) {
