...
public class BlockOverworldSlabBaseColoredName extends BlockModSlab implements IModBlock {

    public BlockOverworldSlabBaseColoredName(String name, Material material, boolean isDouble, CreativeTabs tab, EnumDyeColor color) {
