...
import net.hdt.neutronia.groups.building.blocks.slab.BlockBarkSlab;
import net.hdt.neutronia.groups.building.blocks.stair.BlockBarkStairs;
import net.minecraft.init.Blocks;
import net.minecraft.item.ItemStack;
import net.minecraftforge.fml.common.event.FMLPreInitializationEvent;

public class BarkBlocks extends Component {
