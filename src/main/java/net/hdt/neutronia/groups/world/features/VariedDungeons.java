...
public class VariedDungeons extends Component {
	...
	public void placeDungeonAt(WorldServer world, Random rand, BlockPos position) {
		...
		Template template = world.getStructureTemplateManager().getTemplate(server, new ResourceLocation("neutronia", "dungeon_" + dungeonType));
