...
public class UndergroundBiomeLush extends BasicUndergroundBiome {
	...
	public void setupConfig(String category) {
		grassChance = GroupLoader.config.getInt("Grass Chance", category, 20, 0, Integer.MAX_VALUE, "The higher, the less grass will spawn");
		shrubChance = GroupLoader.config.getInt("Shrub Chance", category, 100, 0, Integer.MAX_VALUE, "The higher, the less shrubs will spawn");
		vineChance = GroupLoader.config.getInt("Vine Chance", category, 8, 0, Integer.MAX_VALUE, "The higher, the less vines will spawn");
	}
