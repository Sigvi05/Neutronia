...
import net.hdt.neutronia.base.client.models.MRLBuilder;
import net.hdt.neutronia.base.util.ColorUtil;
...
public class BlockPot extends BlockMotherlode {
	...
	public void addInformation(ItemStack stack, @Nullable World world, List<String> tooltip, ITooltipFlag advanced) {
		if (stack.hasTagCompound() && stack.getTagCompound().hasKey("PatternColor")) {
			tooltip.add(TextFormatting.GRAY + I18n.format("item.fireworksCharge." + EnumDyeColor.byMetadata(stack.getTagCompound().getInteger("PatternColor")).getTranslationKey()) + " Pattern");
