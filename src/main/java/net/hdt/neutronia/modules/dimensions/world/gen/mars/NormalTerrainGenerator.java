package net.hdt.neutronia.modules.dimensions.world.gen.mars;
...
public class NormalTerrainGenerator {
    ...
    public void setup(World world, Random rand) {
        ...
        this.mainPerlinNoise = new NoiseGeneratorOctaves(rand, 32);
        this.surfaceNoise = new NoiseGeneratorPerlin(rand, 2);
        NoiseGeneratorOctaves noiseGen5 = new NoiseGeneratorOctaves(rand, 10);
        this.depthNoise = new NoiseGeneratorOctaves(rand, 4);
                        ...
                        for (int x = 0; x < 4; ++x) {
                            ...
                            for (int z = 0; z < 4; ++z) {
                                if (height < 2) {
                                    ...
                                    primer.setBlockState(x4 * 4 + x, height32 * 8 + h, z4 * 4 + z, Blocks.STAINED_HARDENED_CLAY.getDefaultState().withProperty(BlockColored.COLOR, EnumDyeColor.RED));
                                }
                            }
