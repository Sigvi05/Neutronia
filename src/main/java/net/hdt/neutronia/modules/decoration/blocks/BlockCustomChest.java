...
import net.hdt.neutronia.modules.decoration.item.ItemChestBlock;
...
public class BlockCustomChest extends BlockChest implements INeutroniaBlock {
	...
	public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack) {
		EnumFacing facing = EnumFacing.fromAngle(MathHelper.floor(placer.rotationYaw * 4.0F / 360.0F + 0.5D) & 3).getOpposite();
