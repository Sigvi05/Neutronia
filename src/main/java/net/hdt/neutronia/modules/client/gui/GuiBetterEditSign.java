package net.hdt.neutronia.modules.client.gui;

import net.hdt.neutronia.modules.client.features.ImprovedSignEdit;
...
public class GuiBetterEditSign extends GuiScreen {
	...
	public void initGui() {
		...
		if(ImprovedSignEdit.enableShift)
			addButton(new GuiButton(6, width / 2 - 41, 147, 40, 20, I18n.format("neutroniaMisc.signShift")));
		if(ImprovedSignEdit.enableClear)
			addButton(new GuiButton(7, width / 2 - 41, (ImprovedSignEdit.enableShift ? 123 : 147), 40, 20, I18n.format("neutroniaMisc.signClear")));
