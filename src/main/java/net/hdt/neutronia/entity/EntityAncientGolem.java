...
public class EntityAncientGolem extends EntityGolem {

    private static final DataParameter<Byte> PLAYER_CREATED = EntityDataManager.createKey(EntityAncientGolem.class, DataSerializers.BYTE);
