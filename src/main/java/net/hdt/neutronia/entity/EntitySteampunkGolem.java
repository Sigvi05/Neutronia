...
public class EntitySteampunkGolem extends EntityGolem {

    protected static final DataParameter<Byte> PLAYER_CREATED = EntityDataManager.<Byte>createKey(EntitySteampunkGolem.class, DataSerializers.BYTE);
    ...
    public EntitySteampunkGolem(World worldIn)
    {
        super(worldIn);
    ...
    {
        EntityLiving.registerFixesMob(fixer, EntitySteampunkGolem.class);
    }
