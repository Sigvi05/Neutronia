...
import net.hdt.neutronia.entity.render.RenderFirefly;
...
public class LayerFireflyGlow implements LayerRenderer<EntityFirefly> {
	...
	private static final ResourceLocation GLOW_TEXTURE = new ResourceLocation(MOD_ID, "textures/particle/particle_glow.png");
