...
public class ModelSteampunkGolem extends ModelBase
{
    ...
    public ModelSteampunkGolem()
    {
        this(0.0F);
    }

    public ModelSteampunkGolem(float p_i1161_1_)
    {
        this(p_i1161_1_, -7.0F);
    }

    public ModelSteampunkGolem(float p_i46362_1_, float p_i46362_2_)
    {
        int i = 128;
        int j = 128;
    ...
    {
        EntitySteampunkGolem entityirongolem = (EntitySteampunkGolem)entitylivingbaseIn;
