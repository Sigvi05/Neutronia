...
public class ModelYetiGolem extends ModelBase {
    /**
    ...
    public ModelYetiGolem() {
        this(0.0F);
    }

    public ModelYetiGolem(float p_i1161_1_) {
        this(p_i1161_1_, -7.0F);
    }

    public ModelYetiGolem(float p_i46362_1_, float p_i46362_2_) {
        int i = 128;
        int j = 128;
