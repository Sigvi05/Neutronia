...
public class EntityDrowned extends EntityMob {
    ...
    public static final DataParameter<Boolean> ARMS_RAISED = EntityDataManager.createKey(EntityDrowned.class, DataSerializers.BOOLEAN);

    public EntityDrowned(World worldIn) {
        super(worldIn);
        this.setSize(0.6F, 1.95F);
        moveHelper = new EntityDrowned.AnglerMoveHelper(this);
    ...
    static class AnglerMoveHelper extends EntityMoveHelper {
        private final EntityDrowned angler;

        public AnglerMoveHelper(EntityDrowned angler) {
            super(angler);
            this.angler = angler;
        }
