...
public class EntityYetiGolem extends EntityGolem {
    ...
    protected static final DataParameter<Byte> PLAYER_CREATED = EntityDataManager.<Byte>createKey(EntityYetiGolem.class, DataSerializers.BYTE);
    ...
    {
        EntityLiving.registerFixesMob(fixer, EntityYetiGolem.class);
    }
