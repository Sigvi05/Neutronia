    ...
    static class AIFlyRandomly extends EntityAIBase {
        ...
        public void doFly(int flag) {
            ...
            if (newDirectionTimer % 2 == 0) {
                ...
                switch (flag) {
                    case 0:
                        Vec3d dir = targetDirection.add(baseVec1.scale(periodicFactor1)).add(baseVec2.scale(periodicFactor2));
                        firefly.moveInDirection(dir);
                        break;
                    case 1:
                        firefly.moveInDirection(new Vec3d(periodicFactor1, firefly.speed, periodicFactor2));
                        break;
                    case 2:
                        firefly.moveInDirection(new Vec3d(periodicFactor1, -firefly.speed, periodicFactor2));
                        break;
