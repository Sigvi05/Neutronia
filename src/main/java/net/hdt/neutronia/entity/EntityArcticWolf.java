...
import net.hdt.neutronia.entity.ai.EntityAIBeg;
...
public class EntityArcticWolf extends EntityTameable {
    private static final DataParameter<Float> DATA_HEALTH_ID = EntityDataManager.<Float>createKey(EntityArcticWolf.class, DataSerializers.FLOAT);
    private static final DataParameter<Boolean> BEGGING = EntityDataManager.<Boolean>createKey(EntityArcticWolf.class, DataSerializers.BOOLEAN);
    private static final DataParameter<Integer> COLLAR_COLOR = EntityDataManager.<Integer>createKey(EntityArcticWolf.class, DataSerializers.VARINT);
    /**
    ...
    public EntityArcticWolf(World worldIn) {
        super(worldIn);
    ...
    public static void registerFixesWolf(DataFixer fixer) {
        EntityLiving.registerFixesMob(fixer, EntityArcticWolf.class);
    }
    ...
    protected void initEntityAI() {
        ...
        this.tasks.addTask(3, new EntityArcticWolf.AIAvoidEntity(this, EntityLlama.class, 24.0F, 1.5D, 1.5D));
    ...
    public EntityArcticWolf createChild(EntityAgeable ageable) {
        EntityArcticWolf entitywolf = new EntityArcticWolf(this.world);
    ...
    public boolean canMateWith(EntityAnimal otherAnimal) {
        if (otherAnimal == this) {
            ...
            return false;
        } else if (!(otherAnimal instanceof EntityArcticWolf)) {
            return false;
        } else {
            EntityArcticWolf entitywolf = (EntityArcticWolf) otherAnimal;
    ...
    public boolean shouldAttackEntity(EntityLivingBase target, EntityLivingBase owner) {
        if (!(target instanceof EntityCreeper) && !(target instanceof EntityGhast)) {
            if (target instanceof EntityArcticWolf) {
                EntityArcticWolf entitywolf = (EntityArcticWolf) target;
    ...
    class AIAvoidEntity<T extends Entity> extends EntityAIAvoidEntity<T> {
        ...
        public AIAvoidEntity(EntityArcticWolf wolfIn, Class<T> p_i47251_3_, float p_i47251_4_, double p_i47251_5_, double p_i47251_7_) {
        ...
        private boolean avoidLlama(EntityLlama p_190854_1_) {
            return p_190854_1_.getStrength() >= EntityArcticWolf.this.rand.nextInt(5);
        }
        ...
        public void startExecuting() {
            EntityArcticWolf.this.setAttackTarget((EntityLivingBase) null);
