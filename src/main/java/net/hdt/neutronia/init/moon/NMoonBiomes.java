package net.hdt.neutronia.init.moon;

import net.hdt.neutronia.world.biome.moon.BiomeMoonMain;
...
public class NMoonBiomes {
    ...
    private static void addBiome(Biome biome, String name, int weight, BiomeType biomeType, Type... types) {
        ...
        System.out.println(String.format("Biome: %s has a %d chance to spawn", name, new BiomeEntry(biome, weight).itemWeight));
    }
