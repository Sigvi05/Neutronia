...
public class ConfigHandler
{
    ...
    @Config.LangKey("config." + MOD_ID + ":potionEffect")
    public static PotionEffectConfig potionEffectConfig = new PotionEffectConfig();

    @Config.Name("entity")
    @Config.LangKey("config." + MOD_ID + ":entity")
    ...
    public static class BlockConfig
    {
        ...
        @Config.Name("rime")
        @Config.LangKey("config." + MOD_ID + ":block.rime")
        public Rime rime = new Rime();

        @Config.Name("thornstalk")
        @Config.LangKey("config." + MOD_ID + ":block.thornstalk")
        public Thornstalk thornstalk = new Thornstalk();

        @Config.Name("hyphae")
        @Config.LangKey("config." + MOD_ID + ":block.hyphae")
        ...
        public class Rime
        {
            @Config.LangKey("config." + MOD_ID + ":block.rime.canFreezeWater")
            public boolean canFreezeWater = true;

            @Config.LangKey("config." + MOD_ID + ":block.rime.canFreezeLava")
            public boolean canFreezeLava = true;

            @Config.LangKey("config." + MOD_ID + ":block.rime.canFreezeMobs")
            public boolean canFreezeMobs = true;
        }

        public class Thornstalk
        {
            @Config.LangKey("config." + MOD_ID + ":block.thornstalk.canDestroyItems")
            public boolean canDestroyItems = false;

            @Config.LangKey("config." + MOD_ID + ":block.thornstalk.blacklist")
            @Config.Comment("Mobs the Thornstalk shouldn't hurt")
            public String[] blacklist = new String[]{
                    "minecraft:wither_skeleton",
                    "minecraft:zombie_pigman",
                    "" + MOD_ID + ":monster_spinout"
            };
        }

        public class Hyphae
        {
            @Config.LangKey("config." + MOD_ID + ":block.hyphae.doesSpread")
    ...
    {
        @Config.Name("freeze")
        @Config.LangKey("config." + MOD_ID + ":potionEffect.freeze")
        public Freeze freeze = new Freeze();

        @Config.Name("spore")
        @Config.LangKey("config." + MOD_ID + ":potionEffect.spore")
        public Spore spore = new Spore();

        @Config.Name("lost")
        @Config.LangKey("config." + MOD_ID + ":potionEffect.lost")
        public Lost lost = new Lost();

        public class Freeze
        {
            @Config.LangKey("config." + MOD_ID + ":potionEffect.freeze.chanceOfThawing")
            ...
            @Config.LangKey("config." + MOD_ID + ":potionEffect.freeze.blacklist")
            ...
            public String[] blacklist = new String[]{
                    ...
                    MOD_ID + ":monster_wight",
                    MOD_ID + ":monster_ember",
                    MOD_ID + ":monster_spinout",
                    MOD_ID + ":monster_bone_spider",
                    MOD_ID + ":monster_brute"
            };
        }

        public class Spore
        {
            @Config.LangKey("config." + MOD_ID + ":potionEffect.spore.chanceOfSporeSpawning")
            ...
            @Config.LangKey("config." + MOD_ID + ":potionEffect.spore.blacklist")
            @Config.Comment("Mobs that shouldn't spawn Spores")
            public String[] blacklist = new String[]{
                    MOD_ID + ":monster_spore_creeper",
                    MOD_ID + ":monster_spore",
                    MOD_ID + ":neutral_mogus"
            };
        }

        public class Lost
        {
            @Config.LangKey("config." + MOD_ID + ":potionEffect.lost.chanceOfGhastlingSpawning")
    ...
    {
        @Config.Name("ember")
        @Config.LangKey("config." + MOD_ID + ":entity.ember")
        public Ember ember = new Ember();

        @Config.Name("nethermite")
        @Config.LangKey("config." + MOD_ID + ":entity.nethermite")
        public Nethermite nethermite = new Nethermite();

        @Config.Name("spinout")
        @Config.LangKey("config." + MOD_ID + ":entity.spinout")
        public Spinout spinout = new Spinout();

        @Config.Name("spore_creeper")
        @Config.LangKey("config." + MOD_ID + ":entity.sporeCreeper")
        public SporeCreeper sporeCreeper = new SporeCreeper();

        @Config.Name("spore")
        @Config.LangKey("config." + MOD_ID + ":entity.spore")
        public Spore spore = new Spore();

        @Config.Name("brute")
        @Config.LangKey("config." + MOD_ID + ":entity.brute")
        public Brute brute = new Brute();

        @Config.Name("ghast_queen")
        @Config.LangKey("config." + MOD_ID + ":entity.ghastQueen")
        public GhastQueen ghastQueen = new GhastQueen();

        public class Ember
        {
            @Config.LangKey("config." + MOD_ID + ":entity.ember.chanceOfSettingPlayerOnFire")
        ...
        {
            @Config.LangKey("config." + MOD_ID + ":entity.nethermite.chanceOfSpawning")
            ...
            @Config.LangKey("config." + MOD_ID + ":entity.nethermite.whitelist")
        ...
        {
            @Config.LangKey("config." + MOD_ID + ":entity.spinout.spinTime")
            ...
            @Config.LangKey("config." + MOD_ID + ":entity.spinout.spinCooldown")
        ...
        {
            @Config.LangKey("config." + MOD_ID + ":entity.sporeCreeper.chanceOfSporeSpawning")
        ...
        public class Spore
        {
            @Config.LangKey("config." + MOD_ID + ":entity.spore.growthTime")
            ...
            @Config.LangKey("config." + MOD_ID + ":entity.spore.creeperSpawns")
        ...
        public class Brute
        {
            @Config.LangKey("config." + MOD_ID + ":entity.brute.chargeCooldown")
        ...
        {
            @Config.LangKey("config." + MOD_ID + ":entity.ghastQueen.ghastlingSpawnCooldown")
            ...
            @Config.LangKey("config." + MOD_ID + ":entity.ghastQueen.ghastlingSpawns")
    ...
    public static class BiomeConfig
    {
        ...
        {
            @Config.LangKey("config." + MOD_ID + ":biome.arcticAbyss.chanceOfFreezing")
