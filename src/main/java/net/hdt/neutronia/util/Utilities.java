...
public class Utilities
{
    ...
    public static void setModInfo(FMLPreInitializationEvent event)
    {
        ...
        event.getModMetadata().credits = TextFormatting.BLUE + CREDITS;
        event.getModMetadata().authorList = AUTHORS;
        event.getModMetadata().description = TextFormatting.YELLOW + DESC;
        event.getModMetadata().url = URL;
        event.getModMetadata().logoFile = LOGO;
        event.getModMetadata().name = TextFormatting.GOLD + NAME;
        event.getModMetadata().version = TextFormatting.LIGHT_PURPLE + VERSION;
    }
