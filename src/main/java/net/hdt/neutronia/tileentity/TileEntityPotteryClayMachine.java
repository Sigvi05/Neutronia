...
public class TileEntityPotteryClayMachine extends TileEntityLockable implements ITickable {
    ...
    public void readFromNBT(NBTTagCompound compound) {
        ...
        this.claySpinningTime = compound.getInteger("claySpinningTime");
        this.cookTime = compound.getInteger("spinTime");
...
//                BlockPotteryClayMachine.setState(this.isActive(), this.world, this.pos);
    ...
    public int getField(int id) {
        switch (id) {
            ...
            case 1:
                return this.currentClaySpinningTime;
            case 2:
    ...
    public void setField(int id, int value) {
        switch (id) {
            case 0:
                ...
                break;
            case 1:
                this.currentClaySpinningTime = value;
                break;
            case 2:
                this.cookTime = value;
                break;
