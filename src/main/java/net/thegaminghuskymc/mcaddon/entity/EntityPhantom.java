...
public class EntityPhantom extends EntityAmbientCreature {
    private static final DataParameter<Byte> HANGING = EntityDataManager.<Byte>createKey(EntityPhantom.class, DataSerializers.BYTE);
    /**
    ...
    public static void registerFixesBat(DataFixer fixer) {
        EntityLiving.registerFixesMob(fixer, EntityPhantom.class);
    }
