...
//        this.addProperty(RAVINE_FREQUENCY);
        ...
        ALLOW_PONDS_WATER = new ConfigPropertyBoolean(ConfigProperty.Type.BOOLEAN, "Allow Ponds (Water)", "Decorations.Ponds", "", true);
        WHEAT_CHANCE = new ConfigPropertyInt(ConfigProperty.Type.INTEGER, "Wheat (Chance)", "Decorations.Wheat", "", 0, 0, Integer.MAX_VALUE);
        WHEAT_MIN_Y = new ConfigPropertyInt(ConfigProperty.Type.INTEGER, "Wheat (Min Y)", "Decorations.Wheat", "", 0, 0, Integer.MAX_VALUE);
        WHEAT_MAX_Y = new ConfigPropertyInt(ConfigProperty.Type.INTEGER, "Wheat (Max Y)", "Decorations.Wheat", "", 0, 0, Integer.MAX_VALUE);
        ...
        ALLOW_SPONGE = new ConfigPropertyBoolean(ConfigProperty.Type.BOOLEAN, "Allow Sponge", "Decorations.Sponge", "", true);
        ALLOW_OCEAN_WAVES = new ConfigPropertyBoolean(ConfigProperty.Type.BOOLEAN, "Allow Ocean Waves", "Decorations.Waves", "", true);
    }
