...
public class WorldGenVolcano {
    ...
    private static IBlockState volcanoPatchBlock3 = getVolcanoBlock(RTGAPI.config().VOLCANO_MIX3_BLOCK_ID.get(), RTGAPI.config().VOLCANO_MIX3_BLOCK_META.get(), RTGConfig.DEFAULT_VOLCANO_MIX3_BLOCK);
