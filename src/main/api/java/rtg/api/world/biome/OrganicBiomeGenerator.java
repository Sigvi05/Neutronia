...
public class OrganicBiomeGenerator {
    ...
    public OrganicBiomeGenerator(IRTGWorld rtgWorld) {
        ...
        organicProvider = new ChunkGeneratorOverworld(rtgWorld.world(), rtgWorld.world().getSeed(), rtgWorld.world().getWorldInfo().isMapFeaturesEnabled(), rtgWorld.world().getWorldInfo().getGeneratorOptions());
