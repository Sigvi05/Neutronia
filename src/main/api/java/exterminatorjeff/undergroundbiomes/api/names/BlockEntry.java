...
public abstract class BlockEntry extends Entry<UBBlock> implements BlockAccess {
    ...
    protected void doRegister() {
        ...
        ForgeRegistries.BLOCKS.register(getBlock().setRegistryName(internalName));
        ForgeRegistries.ITEMS.register(getItemBlock().setRegistryName(getBlock().getRegistryName()));
    }
