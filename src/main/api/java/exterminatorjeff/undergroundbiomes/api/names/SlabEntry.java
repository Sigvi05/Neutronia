...
public final class SlabEntry extends Entry<UBSlab> {
    ...
    protected void doRegister() {
        ...
        ForgeRegistries.BLOCKS.register(getHalfSlab().setRegistryName(name));
        name = internalName + "_fullslab";
        getFullSlab().setUnlocalizedName(name);
        ForgeRegistries.BLOCKS.register(getFullSlab().setRegistryName(name));
        ForgeRegistries.ITEMS.register(getItem().setRegistryName(getHalfSlab().getRegistryName()));
    }
